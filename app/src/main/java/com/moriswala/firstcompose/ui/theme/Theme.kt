package com.moriswala.firstcompose.ui.theme
...
import com.moriswala.firstcompose.ui.theme.*
...
fun YellowTheme(
    ...
    FirstComposeTheme(darkTheme, colors, content)
}
...
private val LightImages = Images(lockupLogo = R.drawable.ic_puppy)

private val DarkImages = Images(lockupLogo = R.drawable.ic_puppy)

@Composable
private fun FirstComposeTheme(
    darkTheme: Boolean,
    colors: Colors,
    content: @Composable () -> Unit
) {
